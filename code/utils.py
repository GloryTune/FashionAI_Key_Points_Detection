...
def get_keypoints(img_category):
    ...
    outwear_flip_map={'neckline_left':'neckline_right',
                     'shoulder_left': 'shoulder_right',
                     'armpit_left': 'armpit_right',
    ...
    dress_flip_map={'neckline_left':'neckline_right',
                     'shoulder_left': 'shoulder_right',
                     'armpit_left': 'armpit_right',
                     'waistline_left': 'waistline_right',
                     'cuff_left_in': 'cuff_right_in',
                     'cuff_left_out': 'cuff_right_out',
                     'hemline_left': 'hemline_right'}
    trousers_flip_map={'waistband_left': 'waistband_right',
                      'bottom_left_in':'bottom_right_in',
                      'bottom_left_out':'bottom_right_out'
                      }

    keypoints_flip_map = {
        'blouse':blouse_flip_map,
        'skirt': skirt_flip_map,
        'outwear': outwear_flip_map,
        'dress': dress_flip_map,
        'trousers':trousers_flip_map
    }
